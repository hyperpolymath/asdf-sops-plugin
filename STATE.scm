...
;; STATE.scm - Project state tracking for asdf-sops-plugin
;; Media-Type: application/vnd.state+scm

(define-state asdf-sops-plugin
  (metadata
    (version "0.1.0")
    (schema-version "1.0.0")
    (created "2026-01-30")
    (updated "2026-01-30")
    (project "asdf-sops-plugin")
    (repo "hyperpolymath/asdf-sops-plugin"))

  (project-context
    (name "asdf-sops-plugin")
